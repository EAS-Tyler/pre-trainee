var fs = require("fs")
var obj = JSON.parse(fs.readFileSync('/Users/trainee/Desktop/Accountmanagement/cats.json'))
...
function kitty() {
    rl.question("Please enter cat name: ", function (newName) {
        ...
        rl.question("Please enter cat colour: ", function (newCol) {
            ...
            rl.close();
            fs.writeFileSync('/Users/trainee/Desktop/Accountmanagement/cats.json', allKittstr)
        })
    })
}
kitty()
