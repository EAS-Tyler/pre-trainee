...
var fs = require('fs');
var obj = JSON.parse(fs.readFileSync('/Users/trainee/Desktop/Accountmanagement/user_accounts2.json'));
...
obj.users.splice(i, 1)
    ...
    fs.writeFileSync('/Users/trainee/Desktop/Accountmanagement/user_accounts2.json', allUserStr)
