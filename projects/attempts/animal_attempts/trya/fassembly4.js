...
function searchA() {
    rl.question("\nPlease write animal name:\n", function (nameA) {
        ...
        for (var i = 0; i < animals.length; i++) {        
            if (nameA == animals[i].name) {
                console.log("\nName: " + animals[i].name) 
                console.log("Species: " + animals[i].species)  // make italic
        ...
        console.log("\nPlease choose an animal from the available list: Lion, Elephant, or Penguin (Case sensitive)")
        return searchA()

         // can be fixed w async

})}


// formating shell or bash  
// object.keys 
